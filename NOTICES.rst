...
5.  ``src/dendropy/dataio/_beast2_v2_7_8_lark_standalone.py`` is generated by
    ...
    "Standalone Mode" code generator. Unlike the rest of DendroPy
    (BSD-licensed; see "LICENSE.rst") and unlike Lark itself (MIT-licensed),
    this generated file is separately licensed, per the notice embedded in
    Lark's generator, under the
