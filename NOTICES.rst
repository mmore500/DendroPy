...
5.  ``src/dendropy/dataio/_beast2_v2_7_8_lark_standalone.py`` is a generated
    ...
    Lark is not a DendroPy runtime dependency: the generated module is
    self-contained and is only ever regenerated (requiring Lark) by
    developers, not by end users or at install time.
